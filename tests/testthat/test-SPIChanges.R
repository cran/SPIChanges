...
test_that("SPIChanges() works as expected in example", {
  ...
  expect_equal(Changes[[1]]$Actual.Acum.Prob[1:4], c(0.420, 0.486, 0.513, 0.549),
               tolerance = 0.05)
  expect_equal(Changes[[1]]$ChangeDryFreq[1:4], c("0",  "0", "NoDrought", "NoDrought"),
               tolerance = 0.05)
  expect_equal(Changes[[2]][1:4,3], c(1, 1, 1, 1),
               tolerance = 0.00)
  expect_equal(Changes[[3]][1:4,3], c(0, 0, 0, 0),tolerance = 0.05)
  expect_equal(Changes[[3]][1:4,4], c(0, 0, 0, 0),tolerance = 0.05)
  ...
  expect_identical(Changes[[3]][1:4,7], c(0, 0, 0, 0))
  expect_identical(Changes[[3]][1:4,8], c(0, 0, 0, 0))
  expect_identical(Changes[[3]][1:4,9], c(0, 0, 0, 0))
  expect_identical(Changes[[4]][1:4,1], c(1, 1, 1, 1))
  expect_identical(Changes[[4]][1:4,2], c(1, 1, 1, 1))
...
test_that("SPIChanges() works when only.linear = no", {
  ...
  expect_equal(Changes[[2]][1:4,3], c(1, 1, 1, 1),
               tolerance = 0.00)
  expect_identical(Changes[[3]][1:4,3], c(0, 0, 0, 0))
  expect_identical(Changes[[3]][1:4,4], c(0, 0, 0, 0))
  expect_equal(Changes[[3]][1:4,5], c(210.51, 228.64, 231.14, 237.84),tolerance = 1)
  expect_equal(Changes[[3]][1:4,6], c(210.51, 228.64, 231.14, 237.84),tolerance = 1)
  expect_identical(Changes[[3]][1:4,7], c(0, 0, 0, 0))
  expect_identical(Changes[[3]][1:4,8], c(0, 0, 0, 0))
...
test_that("SPIChanges() works as expected in example", {
  ...
  expect_equal(Changes[[1]]$Actual.Acum.Prob[1:4], c(0.331, 0.419, 0.392, 0.418),
               tolerance = 0.05)
  expect_equal(Changes[[1]]$ChangeDryFreq[1:4], c("0",  "0",  "0", "0"),
               tolerance = 0.05)
  expect_equal(Changes[[2]][1:4,3], c(1, 1, 1, 1),
               tolerance = 0.00)
  expect_identical(Changes[[3]][1:4,3], c(0, 0, 0, 0))
